  ...
  return (
    <div className="testimonials">
      <div className="testimonials-sec1">
        <div className="testimonials-left flex-wrap  ">
          <div className="testimonials-content-holder  ">
            <p className="content-1">Testimonials</p>
            <p className="testimonials-heading flex-wrap">What people say about Us.</p>
            <div className="testimonials-left-lower-box">
              <img
        ...
        <div className="testimonials-right ">
          <div className="testimonials-card w-100">
          ...
          <div className="testimonial-small-card w-100 ">
            <div className="testimonials-right-small-content bg-gray-100">
              <p className="book-left-heading ">Chris Thomas</p>
              <p className="book-right-small-description">CEO of Red Button</p>
            </div>
          </div>
        </div>
      </div>
      <div className="testimonials-sec2 flex-wrap">
       
          <img
            className="testimonials-sec2-image"
